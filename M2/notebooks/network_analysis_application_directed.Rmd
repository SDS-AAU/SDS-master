...
* We have another important concept that often explains edge-formation in social networks: **Assortativity**, also called **homopholy**. 
...
* That means, that we have small interconected clusters, which are in turn connected by **gatekeepers** (the edges we call **bridges** or **structural holes**). 
...
Looks kind of different. However, one randomly created network doesn't present a good bseline. So, lets better create a bunch, and compare our network to the average values of the randomly generated ones.
